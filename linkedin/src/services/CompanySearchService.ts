...
export const LINKEDIN_COUNTRY_GEO_MAP: Record<string, { geoId: string; name: string; code: string; flag: string }> = {
  ...
  unitedkingdom: { geoId: '102257491', name: 'United Kingdom', code: 'GB', flag: '🇬🇧' },
  uk: { geoId: '102257491', name: 'United Kingdom', code: 'GB', flag: '🇬🇧' },
  ...
  china: { geoId: '102884285', name: 'China', code: 'CN', flag: '🇨🇳' },
  ...
  vietnam: { geoId: '106155005', name: 'Vietnam', code: 'VN', flag: '🇻🇳' },
  thailand: { geoId: '105490917', name: 'Thailand', code: 'TH', flag: '🇹🇭' },
  southafrica: { geoId: '105309088', name: 'South Africa', code: 'ZA', flag: '🇿🇦' },
  ...
  bangladesh: { geoId: '106670623', name: 'Bangladesh', code: 'BD', flag: '🇧🇩' },
  ...
  czechrepublic: { geoId: '104769905', name: 'Czech Republic', code: 'CZ', flag: '🇨🇿' },
  czechia: { geoId: '104769905', name: 'Czech Republic', code: 'CZ', flag: '🇨🇿' },
  romania: { geoId: '106670623', name: 'Romania', code: 'RO', flag: '🇷🇴' },
  hungary: { geoId: '100288708', name: 'Hungary', code: 'HU', flag: '🇭🇺' },
  ...
  kuwait: { geoId: '102855770', name: 'Kuwait', code: 'KW', flag: '🇰🇼' },
  panama: { geoId: '103867087', name: 'Panama', code: 'PA', flag: '🇵🇦' },
  costarica: { geoId: '100293800', name: 'Costa Rica', code: 'CR', flag: '🇨🇷' },
  uruguay: { geoId: '100867946', name: 'Uruguay', code: 'UY', flag: '🇺🇾' },
  ecuador: { geoId: '105816943', name: 'Ecuador', code: 'EC', flag: '🇪🇨' },
  guatemala: { geoId: '104445899', name: 'Guatemala', code: 'GT', flag: '🇬🇹' },
  dominicanrepublic: { geoId: '105828498', name: 'Dominican Republic', code: 'DO', flag: '🇩🇴' },
  srilanka: { geoId: '101168579', name: 'Sri Lanka', code: 'LK', flag: '🇱🇰' },
  kenya: { geoId: '100710459', name: 'Kenya', code: 'KE', flag: '🇰🇪' },
  morocco: { geoId: '102787409', name: 'Morocco', code: 'MA', flag: '🇲🇦' },
  ghana: { geoId: '105460592', name: 'Ghana', code: 'GH', flag: '🇬🇭' },
  jordan: { geoId: '106368470', name: 'Jordan', code: 'JO', flag: '🇯🇴' },
  lebanon: { geoId: '106596482', name: 'Lebanon', code: 'LB', flag: '🇱🇧' },
  bahrain: { geoId: '102046473', name: 'Bahrain', code: 'BH', flag: '🇧🇭' },
  oman: { geoId: '103038473', name: 'Oman', code: 'OM', flag: '🇴🇲' },
  luxembourg: { geoId: '104246759', name: 'Luxembourg', code: 'LU', flag: '🇱🇺' },
  iceland: { geoId: '102120677', name: 'Iceland', code: 'IS', flag: '🇮🇸' },
  croatia: { geoId: '104688944', name: 'Croatia', code: 'HR', flag: '🇭🇷' },
  slovakia: { geoId: '106805788', name: 'Slovakia', code: 'SK', flag: '🇸🇰' },
  slovenia: { geoId: '100342525', name: 'Slovenia', code: 'SI', flag: '🇸🇮' },
  estonia: { geoId: '103738706', name: 'Estonia', code: 'EE', flag: '🇪🇪' },
  latvia: { geoId: '105740417', name: 'Latvia', code: 'LV', flag: '🇱🇻' },
  lithuania: { geoId: '103527419', name: 'Lithuania', code: 'LT', flag: '🇱🇹' },
  cyprus: { geoId: '100768472', name: 'Cyprus', code: 'CY', flag: '🇨🇾' },
  malta: { geoId: '106720496', name: 'Malta', code: 'MT', flag: '🇲🇹' },
  ukraine: { geoId: '102264447', name: 'Ukraine', code: 'UA', flag: '🇺🇦' },
  kazakhstan: { geoId: '104195383', name: 'Kazakhstan', code: 'KZ', flag: '🇰🇿' },
  bulgaria: { geoId: '105315481', name: 'Bulgaria', code: 'BG', flag: '🇧🇬' },
